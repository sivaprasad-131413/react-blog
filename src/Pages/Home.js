        ...
        <div className="home__container">
          ...
          <div className="home__sec">
            <Link to="/fitness">
              {" "}
              <img
                src="https://images.unsplash.com/photo-1580274455191-1c62238fa333?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cG9yc2NoZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
                alt="not foun"
              />
            </Link>
          </div>
